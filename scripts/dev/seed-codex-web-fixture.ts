...
const dbPath = resolve(argValue('--db', process.env.DB_PATH ?? '/tmp/orbix-dev-codex-web/orbix.db')!)
...
const session = store.sessions.getOrCreateSession(tag, {
    path: '/tmp/orbix-fixture-workspace',
    host: 'orbix-dev-fixture',
    version: 'dev',
    flavor: 'codex',
    ...
    },
    {
        ...
        content: {
            ...
            content: {
                ...
                data: {
                    type: 'message',
                    message: 'Codex fixture response visible in ORBIX Web.',
                    id: 'fixture-msg-1'
                }
            },
            meta: { sentFrom: 'fixture' }
