...
vi.mock('@/configuration', () => ({
    configuration: {
        happyHomeDir: '/tmp/.orbix',
        logsDir: '/tmp/.orbix/logs',
...
describe('bootstrapExistingSession', () => {
    ...
    it('loads an existing ORBIX session and reports it to the runner', async () => {
        ...
        expect(result.sessionInfo.id).toBe('orbix-session-1')
