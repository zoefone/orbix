    ...
    describe('assertCodexLocalSupported', () => {
        ...
        it('fails when codex is too old', () => {
            ...
            expect(() => assertCodexLocalSupported()).toThrow(
                'Codex CLI 0.124.0+ is required for orbix codex local mode because ORBIX depends on stable hooks. Detected: 0.123.9. Please upgrade Codex and retry.'
            )
        })
        ...
        it('fails when the version output cannot be parsed', () => {
            ...
            expect(() => assertCodexLocalSupported()).toThrow(
                'Could not determine Codex CLI version. Codex CLI 0.124.0+ is required for orbix codex local mode because ORBIX depends on stable hooks. Please upgrade Codex and retry.'
            )
        })
        ...
        it('fails when codex is not available on PATH', () => {
            ...
            expect(() => assertCodexLocalSupported()).toThrow(
                'Codex CLI 0.124.0+ is required for orbix codex local mode because ORBIX depends on stable hooks. Codex was not found on PATH. Please install or upgrade Codex and retry.'
            )
        })
        ...
        it('fails when codex version exits unsuccessfully', () => {
            ...
            expect(() => assertCodexLocalSupported()).toThrow(
                'Could not determine Codex CLI version. codex failed Codex CLI 0.124.0+ is required for orbix codex local mode because ORBIX depends on stable hooks. Please upgrade Codex and retry.'
            )
        })
    })
})
