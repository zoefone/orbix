...
function resolveWindowsShellCommand(): string[] {
    const configuredShell = process.env.ORBIX_TERMINAL_SHELL?.trim()
    if (configuredShell) {
...
export class TerminalManager {
    ...
    constructor(options: TerminalManagerOptions) {
        ...
        this.idleTimeoutMs = options.idleTimeoutMs ?? resolveEnvNumber('ORBIX_TERMINAL_IDLE_TIMEOUT_MS', DEFAULT_IDLE_TIMEOUT_MS)
        this.maxTerminals = options.maxTerminals ?? resolveEnvNumber('ORBIX_TERMINAL_MAX_TERMINALS', DEFAULT_MAX_TERMINALS)
