...
import { getBuiltinSlashCommands, mergeSlashCommands } from '@orbix/protocol/slashCommands';
import type { SlashCommand, SlashCommandsResponse } from '@orbix/protocol/apiTypes';

export type { SlashCommand } from '@orbix/protocol/apiTypes';
