import type { ClientToServerEvents } from '@orbix/protocol'
import { z } from 'zod'
import { randomUUID } from 'node:crypto'
import type { CodexCollaborationMode, PermissionMode } from '@orbix/protocol/types'
import { isRedundantGoalStatusEventContent } from '@orbix/protocol/messages'
...
export function registerSessionHandlers(socket: CliSocketWithData, deps: SessionHandlersDeps): void {
    ...
    socket.on('message', (data: unknown) => {
        ...
        if (teamDelta) {
            ...
            const existingTeamState = existingSession?.teamState as import('@orbix/protocol/types').TeamState | null | undefined
    ...
    socket.on('session-end', (data: SessionEndPayload) => {
        ...
        // invoked_at.  See ORBIX Bot R4: stamping a mature scheduled row here would
