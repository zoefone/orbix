...
export function createSocketServer(deps: SocketServerDeps): {
    ...
    const idleTimeoutMs = resolveEnvNumber('ORBIX_TERMINAL_IDLE_TIMEOUT_MS', DEFAULT_IDLE_TIMEOUT_MS)
    const maxTerminals = resolveEnvNumber('ORBIX_TERMINAL_MAX_TERMINALS', DEFAULT_MAX_TERMINALS)
