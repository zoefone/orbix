/**
 * Configuration for orbix-hub (Direct Connect)
 *
 ...
 * - CLI_API_TOKEN: Shared secret for orbix CLI authentication (auto-generated if not set)
 ...
 * - ORBIX_LISTEN_HOST: Host/IP to bind the HTTP service (default: 127.0.0.1)
...
class Configuration {
    ...
    static async create(): Promise<Configuration> {
        ...
        const dataDir = process.env.ORBIX_HOME
