...
import { buildQwenSessionUpdateMessage, isQwenSafeClientFrame } from '@orbix/protocol/voice'
...
export function createQwenProxyWebSocketHandler(
    ...
    // session.update before ORBIX's tools/voice/instructions are locked into the upstream session.
