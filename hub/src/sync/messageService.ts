import {
    ORBIX_SESSION_EXPORT_SCHEMA_VERSION,
    SESSION_EXPORT_MESSAGE_LIMIT,
    type OrbixSessionExportResult
} from '@orbix/protocol/sessionExport'
import type { AttachmentMetadata, DecryptedMessage, Session } from '@orbix/protocol/types'
import {
    isClaudeChatVisibleMessage,
    isRedundantGoalStatusEventContent,
    unwrapRoleWrappedRecordEnvelope
} from '@orbix/protocol/messages'
...
export class MessageService {
    ...
    getSessionExport(
        ...
        return {
            type: 'success',
            payload: {
                schemaVersion: ORBIX_SESSION_EXPORT_SCHEMA_VERSION,
                exportedAt: Date.now(),
                session,
                messages
            }
     ...
     * silently dropped.  See ORBIX Bot R4 finding.
     *
