import type { Machine, MachinePatch } from '@orbix/protocol/types'
import { MachineHealthSchema, MachineMetadataSchema, RunnerStateSchema } from '@orbix/protocol/schemas'
