 ...
 *
 * This module provides the unified configuration for the Orbix Voice Assistant,
...
export const VOICE_AGENT_NAME = 'Orbix Voice Assistant'
...
export const VOICE_FIRST_MESSAGE = "Hey! Orbix here — what can I help you with?"
...
/**
 * Build the agent configuration for Orbix Voice Assistant.
