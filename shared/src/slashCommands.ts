...
export const BUILTIN_SLASH_COMMANDS = {
    ...
    codex: [
        ...
        { name: 'help', description: 'Show supported ORBIX Codex slash commands', source: 'builtin' },
    ...
    opencode: [
        { name: 'help', description: 'Show supported ORBIX OpenCode slash commands', source: 'builtin' },
