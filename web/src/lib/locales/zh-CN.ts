export default {
  ...
  'login.server.description': '设置 ORBIX 服务器地址以使用 API 和实时更新。',
  ...
  'sessions.home.title': '随时开始',
  'sessions.home.hint': '启动新的智能体，或选择已有会话，从当前设备继续工作。',
  'sessions.empty.hint': '在 workspace 下任意目录启动一个会话，或先浏览目录树看看。',
  'sessions.empty.startSession': '启动会话',
  'sessions.empty.browse': '浏览 workspace',
  'sessions.empty.desktopHint': '从侧边栏选择会话，即可查看实时进度、文件、审批请求和终端。',
  ...
  'codexSync.tooltip': '从 Codex 导入会话到 Orbix',
  'codexSync.confirm.title': '导入 Codex 会话',
  'codexSync.confirm.description': '选择需要导入到 Orbix 的 Codex 会话',
  ...
  'codexSync.success.body': '已导入 {n} 个 Codex 会话到 Orbix。',
  ...
  'session.cursorMigration.bannerAmbiguous.body': '此会话在磁盘上的多个工作区下存在，或本地存储大小与已同步的历史记录不匹配，因此 ORBIX 拒绝自动迁移。请在 hub 日志中搜索 "[migrator] ambiguous legacy store" 或 "[migrator] size sanity check refused" 获取候选列表，删除 ~/.cursor/chats/ 下的陈旧目录后，再重新打开此会话。',
  ...
  'composer.codexSlashUnsupported.body': 'ORBIX 远程模式暂不支持 {command} 这类 Codex 内建 slash command，请改用自然语言，或在本地 Codex TUI 中执行。',
  ...
  'pwa.update.body': '重新加载以获取最新版 ORBIX',
  'pwa.update.reload': '重新加载',
  'pwa.update.whyToggle': '为什么不能关闭此提示？',
  'pwa.update.whyBody': '当你可能有正在运行的智能体、待处理的权限请求或未发送的消息时，ORBIX 不会自动重新加载标签页。旧版网页与当前服务器一起运行可能导致同步错误和操作失败。此横幅会一直保持显示，直到你重新加载，以免你在不知情的情况下停留在旧版本 — 但何时点击「重新加载」由你决定，可以先完成手头的工作。',
  ...
  'settings.connection.change': '更换',
  'settings.connection.description': '更换 Hub 或账户；本设备保存的当前 Hub 访问令牌将被移除。',
  'settings.notifications.title': '通知',
  'settings.notifications.device': '任务通知',
  'settings.notifications.description': 'Orbix 在后台时接收工作状态、完成、失败和审批提醒。',
  'settings.notifications.enabledDescription': '本设备将接收任务状态与审批提醒。',
  'settings.notifications.insecure': '通知需要 HTTPS。请通过安全的 Hub 地址或隧道打开 Orbix。',
  'settings.notifications.unsupported': '当前浏览器不支持通知。在 iPhone 或 iPad 上请先将 Orbix 添加到主屏幕。',
  'settings.notifications.blocked': '通知已被阻止，请在浏览器或系统设置中允许。',
  'settings.notifications.enable': '启用',
  'settings.notifications.disable': '关闭',
  'settings.notifications.working': '处理中…',
  'settings.notifications.test': '发送测试',
  'settings.notifications.testing': '发送中…',
  'settings.notifications.testSent': '测试通知已发送。请锁屏或将 Orbix 切到后台，确认系统通知栏出现提醒。',
  'settings.notifications.testFailed': '测试通知未送达，请重新启用通知后再试。',
  'settings.notifications.enabledFeedback': '已为本设备启用通知。',
  'settings.notifications.disabledFeedback': '已关闭本设备通知。',
  'settings.notifications.notGranted': '未获得通知权限。',
  'settings.notifications.error': '通知设置失败，请检查安全连接后重试。',
  ...
  'settings.voice.fixtures.hint': '随应用发布：工具、路由、语音输出规则。升级 ORBIX 时更新，此处不可编辑。',
  'settings.voice.identity.title': '身份与品牌',
  'settings.voice.identity.hint': '语音助手是谁。ORBIX 是应用本身；可在此改名或换人设。提供商护栏会单独附加。',
  ...
  'browse.noMachinesConnected': '没有已连接的 CLI。在某台机器上运行 `orbix runner start --workspace-root /path/a --workspace-root /path/b` 来开始。',
