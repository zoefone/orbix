export default {
  ...
  'login.server.description': 'Set orbix hub origin for API and live updates.',
  'login.server.current': 'Current:',
  'login.server.origin': 'Hub origin',
  'login.server.placeholder': 'https://orbix.example.com',
  ...
  'sessions.home.title': 'Ready when you are',
  'sessions.home.hint': 'Start a new agent or choose an existing session to continue work from this device.',
  ...
  'sessions.empty.desktopHint': 'Select a session from the sidebar to inspect its live timeline, files, approvals, and terminal.',
  ...
  'codexSync.tooltip': 'Import sessions from Codex into Orbix',
  'codexSync.confirm.title': 'Import Codex sessions',
  'codexSync.confirm.description': 'Choose Codex sessions to import into Orbix',
  ...
  'codexSync.success.body': 'Imported {n} Codex session(s) into Orbix.',
  ...
  'session.cursorMigration.bannerAmbiguous.body': 'This chat exists on disk in multiple workspace folders or the on-disk size does not match the synced history, so ORBIX refused to transplant it automatically. Check hub logs for the candidate list (search for "[migrator] ambiguous legacy store" or "[migrator] size sanity check refused"), delete the stale drawers under ~/.cursor/chats/, and reopen the session.',
  ...
  'composer.codexSlashUnsupported.body': 'ORBIX remote mode does not yet run built-in Codex slash commands like {command}. Use natural language instead, or run it in the local Codex TUI.',
  ...
  'settings.connection.hub': 'Orbix Hub',
  'settings.connection.change': 'Change',
  'settings.connection.description': 'Change Hub or account. Your saved access token for this Hub will be removed from this device.',
  'settings.notifications.title': 'Notifications',
  'settings.notifications.device': 'Task notifications',
  'settings.notifications.description': 'Get status, completion, failure and approval alerts when Orbix is in the background.',
  'settings.notifications.enabledDescription': 'This device will receive task and approval alerts.',
  'settings.notifications.insecure': 'Notifications require HTTPS. Open Orbix through a secure Hub URL or tunnel.',
  'settings.notifications.unsupported': 'Not available in this browser. On iPhone or iPad, install Orbix to the Home Screen first.',
  'settings.notifications.blocked': 'Notifications are blocked. Allow them in your browser or system settings.',
  ...
  'settings.notifications.testSent': 'Test sent. Lock or background this device and confirm the Orbix notification appears.',
  'settings.notifications.testFailed': 'The test could not be delivered. Re-enable notifications and try again.',
  'settings.notifications.enabledFeedback': 'Notifications enabled for this device.',
  'settings.notifications.disabledFeedback': 'Notifications disabled for this device.',
  'settings.notifications.notGranted': 'Notification permission was not granted.',
  'settings.notifications.error': 'Could not update notifications. Check the secure connection and try again.',
  ...
  'settings.voice.fixtures.hint': 'Shipped with the app: tools, routing, TTS rules. Updated when you upgrade ORBIX — not editable here.',
  'settings.voice.identity.title': 'Identity & brand',
  'settings.voice.identity.hint': 'Who the voice assistant is. ORBIX is the app; rename or rebrand the persona here (e.g. overseer). Provider guardrails are always applied separately.',
  ...
  'browse.noMachinesConnected': 'No CLI connected. Run `orbix runner start --workspace-root /path/a --workspace-root /path/b` on a machine to get started.',
