...
import { AGENT_MESSAGE_PAYLOAD_TYPE, asNumber, asString, isObject } from '@orbix/protocol'
import { isClaudeChatVisibleMessage } from '@orbix/protocol/messages'
...
export function normalizeAgentRecord(
    ...
    if (content.type === 'output') {
        ...
        // Skip meta/compact-summary messages (parity with orbix-app)
