...
describe('SessionList collapse behavior', () => {
    ...
    function getProjectPanel(): Element {
        const header = screen.getByTitle('/work/orbix')
    ...
    it('keeps a selected running path collapsed across live session-list refreshes', async () => {
        const baseSessions = [
            makeSession({
                ...
                updatedAt: 100,
                metadata: { path: '/work/orbix', name: 'Running task', flavor: 'codex' },
            }),
            makeSession({
                id: 'session-old',
                updatedAt: 50,
                metadata: { path: '/work/orbix', name: 'Older task', flavor: 'codex' },
            })
        ]
        ...
        fireEvent.click(screen.getByTitle('/work/orbix'))
    ...
    it('auto-expands the path again when the selected session changes', async () => {
        const sessions = [
            ...
            makeSession({
                id: 'session-next',
                updatedAt: 90,
                metadata: { path: '/work/orbix', name: 'Next task', flavor: 'codex' },
            })
        ]
